...
'''
try:
    plt.rcParams['font.sans-serif'] = ['SimHei']# for Chinese characters，库文件添加字体
...
class BacktestingEngine(object):
    ...
    #----------------------------------------------------------------------
    def setStartDate(self, startDate='20170915', initDays=31):
        """设置回测的启动日期"""
    ...
    def calculateBacktestingResult(self):
        ...
        d['WinningSum'] = winningResult
        d['LosingSum'] = losingResult
    ...
    def showBacktestingResult(self):
        ...
        self.output(u'盈利次数：\t%s' % formatNumber(d['WinningSum'])) 
        self.output(u'亏损次数：\t%s' % formatNumber(d['LosingSum']))         
